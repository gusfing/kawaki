...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <url><loc>https://www.kawaki.co.in/shopify</loc><changefreq>monthly</changefreq><priority>0.7</priority></url>
${blogs.map(b => `  <url><loc>https://www.kawaki.co.in/blog-post?slug=${b.slug}</loc><changefreq>monthly</changefreq><priority>0.8</priority></url>`).join('\n')}
</urlset>`;
